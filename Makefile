...
SOURCES := src/main.cpp src/glad.c src/Input.cpp src/Shadder.cpp src/VertexBuffer.cpp src/IndexBuffer.cpp src/VertexArray.cpp src/Render.cpp src/Math/Vector2D.cpp
