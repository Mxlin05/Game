...
public:
    ...
    Shader(const char* filepath){
        ...
        parseShader(source, vertexSource, fragmentSource);

        unsigned int vertexShader = compile(GL_VERTEX_SHADER, vertexSource.c_str());
        unsigned int fragmentShader = compile(GL_FRAGMENT_SHADER, fragmentSource.c_str());
...
private:
    ...
    void parseShader(const std::string& source, std::string& vertexSource, std::string& fragmentSource){
