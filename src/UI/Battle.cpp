...
void BattleUI::render(Render &renderer, Shader &shader, TextRenderer &textRenderer) {
    ...
    renderText(renderer, shader, textRenderer, buttonX_topl, buttonY_topl, buttonText1);
    renderText(renderer, shader, textRenderer, buttonX_topr, buttonY_topr, buttonText2);
    renderText(renderer, shader, textRenderer, buttonX_botl, buttonY_botl, buttonText3);
    renderText(renderer, shader, textRenderer, buttonX_botr, buttonY_botr, buttonText4);
}
...
void BattleUI::renderText(Render &renderer, Shader &shader, TextRenderer &textRenderer, float buttonX, float buttonY, std::string buttonText) {
